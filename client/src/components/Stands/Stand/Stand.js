...
const Likes = () => {
  ...
  return (
    <Card sx={{ maxWidth: 345 }}>
      ...
      <CardMedia className={classes.media} image={stand.selectedFile || 'https://user-images.githubusercontent.com/194400/49531010-48dad180-f8b1-11e8-8d89-1e61320e1d82.png'} title={stand.title} />
      ...
      <CardContent>
        <Typography  gutterBottom variant="h5" component="h2">{stand.street}</Typography>
        <Typography variant="body2" color="textSecondary" component="p">{stand.locationDescription}</Typography>
      </CardContent>
      </CardActionArea>
